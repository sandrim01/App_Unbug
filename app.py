...
def create_app():
    ...
    # Configure database
    app.config["SQLALCHEMY_DATABASE_URI"] = os.environ.get("DATABASE_URL", "postgresql://postgres:SFCIsOJjlcROOhTsqmecmUlMMyUdnOzQ@caboose.proxy.rlwy.net:56918/railway")
    ...
    with app.app_context():
        # Import models
        from models import User, Employee, Client, Supplier, ServiceOrder, Project, StockItem, StoreItem, FinancialEntry, Ticket
