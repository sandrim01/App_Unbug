...
def add_item(order_id):
    ...
    form.inventory_item_id.choices = [(item.id, item.name) for item in StockItem.query.all()]
    
    if form.validate_on_submit():
        inventory_item = StockItem.query.get(form.inventory_item_id.data)
...
def remove_item(order_id, item_id):
    ...
    inventory_item = StockItem.query.get(order_item.inventory_item_id)
